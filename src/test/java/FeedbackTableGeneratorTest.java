...
public class FeedbackTableGeneratorTest {
    ...
    public void testGenerateComplaintTable() {
        ...
        String expectedTable = "<table><tr><th>Name</th><th>Email</th><th>Nachricht</th></tr>" +
                "<tr><td>John Doe</td><td>johndoe@example.com</td><td>This is a complaint message</td></tr>" +
                "<tr><td>Jane Smith</td><td>janesmith@example.com</td><td>Another complaint message</td></tr>" +
                "</table>";
    ...
    public void testGenerateFeedbackTable() {
        ...
        String expectedTable = "<table><tr><th>Name</th><th>Email</th><th>Nachricht</th></tr>" +
                "<tr><td>John Doe</td><td>johndoe@example.com</td><td>This is a feedback message</td></tr>" +
                "<tr><td>Mike Johnson</td><td>mikejohnson@example.com</td><td>Yet another feedback</td></tr>" +
                "</table>";
